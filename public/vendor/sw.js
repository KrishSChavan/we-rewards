...
// (index.html + terminal.js + terminal.css).
const CACHE = 'werewards-terminal-v34';   // v34: a crash report carries the vendor ID as well as the name, which is what tells two locations of one chain apart in the operator's error log — they share a name, so the name alone could never say which till it was. terminal.js only
