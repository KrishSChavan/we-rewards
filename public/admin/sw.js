...
const CACHE = 'werewards-admin-v22';   // v22: the reset dialog says whether the code was EMAILED, so the operator knows whether they still have to read eight characters down the phone (migration-047)
const SHELL = [
