...
const CACHE = 'werewards-v89';   // v89: link a student email from Account (migration-057) — a new section, a new five-view sheet, and the styles for both. index.html AND app.js AND styles.css, so skipping this bump ships the feature to nobody who has the app installed: they keep the cached shell, the button never appears, and the only students who see it are the ones using the site in a browser tab
