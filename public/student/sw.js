...
const CACHE = 'werewards-v92';   // v92: the invite bonus is paid to BOTH sides at signup (migration-058), so the Invite button no longer says "when they buy something" and History labels a referrer payout "A friend joined with your invite". app.js only, but an installed PWA left on v91 keeps telling students their bonus is waiting on a purchase that is no longer part of the deal — which is the one thing the change was made to stop
