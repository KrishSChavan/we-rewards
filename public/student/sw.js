...
const CACHE = 'werewards-v85';   // v85: the ambassador QR sheet (migration-053). index.html gained the Account button and the sheet markup, and app.js/styles.css gained everything behind them — all three are precached, so without this bump an installed PWA keeps the old shell and an ambassador sees no button at all while the server happily answers /api/me/ambassador
